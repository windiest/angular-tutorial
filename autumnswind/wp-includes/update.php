...
function wp_version_check() {
	...
	$url = 'http://api.wp4sae.org/core/version-check/1.6/?' . http_build_query( $query, null, '&' );
...
function wp_update_plugins() {
	...
	$raw_response = wp_remote_post('http://api.wp4sae.org/plugins/update-check/1.0/', $options);
...
function wp_update_themes() {
	...
	$raw_response = wp_remote_post( 'http://api.wp4sae.org/themes/update-check/1.0/', $options );
